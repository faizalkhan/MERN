...
import { getAllProducts, deleteProduct } from "../src/services/api"; // Import your CRUD functions
...
import Drawer from "../src/components/filtersidemenu/Drawer";
...
function HomePage({ isAuthenticated }) {
  ...
  const handleDelete = async (productId) => {
    ...
    try {
      ...
      queryClient.invalidateQueries(["products", searchQuery, serializedFilters]);
